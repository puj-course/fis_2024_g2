...
//     const { currentTrack, isPlaying, togglePlayPause, skipForward, skipBackward, currentTime, duration, paused } = usePlayer();
...
//     return(
//         <div className={`${isPlaying === false && paused === false ? 'hidden' : '' }  w-screen fixed bottom-0 left-0 h-20 bg-gray-300 dark:bg-zinc-900 dark:text-white transition-colors flex gap-7 items-center justify-center p-8`}>
